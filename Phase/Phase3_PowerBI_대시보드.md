...
> Power BI Desktop에서 OneDrive Excel을 연결하고, 3개 페이지 대시보드 + AI 시각화를 제작하여 Power BI Service에 게시한다.
...
OneDrive에 저장된 분석 결과(production_results.xlsx, production_week.xlsx)를
Power BI Desktop에서 연결하고, 3개 페이지 대시보드를 제작한다.
Power BI 내장 AI 시각화(Key Influencers, Decomposition Tree, Smart Narrative)를 배치하고,
Power BI Service에 게시하여 자동 새로고침(하루 8회)을 설정한다.
...
| # | 항목 | 상태 | 비고 |
|---|---|---|---|
| 1 | Power BI Desktop → OneDrive Excel 연결 | 🔲 미시작 | production_week, production_results, line_master |
...
| 6 | Power BI Service 게시 + 자동 새로고침 | 🔲 미시작 | 하루 8회 (E3 Pro) |
...
### 데이터 연결
- OneDrive /production/ 내 Excel 2개 + /config/line_master.xlsx
- OneDrive 직접 연결 (공식 지원, 안정적)
